...
#   config.mailer_sender = 'thinQtvStaff@gmail.com'
   ...
   config.omniauth :facebook, "566814783947187", "841733b04b92defa62fde1b29f0da0ac", callback_url: "https://localhost:3000/users/auth/facebook/callback"#"https://boiling-reef-18462.herokuapp.com/users/auth/facebook/callback"
end