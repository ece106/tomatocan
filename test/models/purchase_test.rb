...
class PurchaseTest < ActiveSupport::TestCase
  def setup
    ...
    @user        = users(:one)
    @merchandise = merchandises(:seven)
  end
  ...
  test "groupcut calculation with group_id present" do
    ...
    actual_groupcut   = @purchase.calculate_groupcut merchandise_price
  ...
  # TODO: test amount, test appfee = ((amt * 5)/100) calculation

  # TODO: Create a test to test the existence of Customer
  # test "save_with_payment should not save without customer" do
  #   @customer = Customer.new
  #   assert_not @customer, "Cannot save payment without a customer"
  # end

  # TODO: Test fails without a valid CC
