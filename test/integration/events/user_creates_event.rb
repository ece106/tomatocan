...
class UserCreatesEvent < ActionDispatch::IntegrationTest
  ...
  test "user creates event with valid attributes" do
    ...
    select "", from: "event_start_at_1i"
    select "", from: "event_start_at_2i"
    select "", from: "event_start_at_3i"
    select "", from: "event_start_at_4i"
    select "", from: "event_start_at_5i"
    ...
    within 'eventSubmit' do
      click 'Post Conversation'
    end
