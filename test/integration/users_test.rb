...
class UsersTest < ActionDispatch::IntegrationTest
    ...
    visit ('http://localhost:3000/')
        def signUpUser()
            ...
            fill_in(id:'user_name', with: 'myName')
    ...
    test "Should see show" do
        assert_text("eventTwo")
    end
    test "Should click show" do
