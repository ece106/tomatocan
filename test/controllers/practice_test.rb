...
#    sign_in @user
  ...
  test "should create user" do # To test whether address/zip from IP is saved, need to test registrations controller. But can't do on localhost.
    assert_difference(1, 1) do
      post :create, params: { user: { name: 'samiam', email: 'fakeunique@fake.com', author: 'itme', created_at: '13', updated_at: '14', encrypted_password: 'secret12', permalink: 'samlink' } }
    end
